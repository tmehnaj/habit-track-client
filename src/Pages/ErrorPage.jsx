...
import errorImg from '../assets/error404 (1).jpg'
...
const ErrorPage = () => {
    ...
    return (
        ...
        <div className='flex items-center justify-between gap-3'>
                        <button onClick={() => { navigate(-1) }} className="gradient-btn-primary-1">Go Back!</button>
            <button onClick={() => { navigate('/') }} className="gradient-btn-primary-2">Go Home!</button>
